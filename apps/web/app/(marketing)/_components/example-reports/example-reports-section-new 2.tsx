...
export function ExampleReportsSectionNew() {
  ...
  return (
    <section
      className="relative bg-zinc-50 px-6 py-24 md:px-8"
      id="example-reports"
    >
      {/* Subtle background pattern */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-0 -left-1/4 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-zinc-200/50 to-transparent blur-3xl" />
