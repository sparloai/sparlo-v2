    ...
    <div className="px-6 py-10 md:px-10 md:py-12">
      ...
      <header className="mb-12 max-w-[65ch]">
        ...
        >
          ...
          <h1 className="mt-3 text-[36px] leading-[1.1] font-semibold tracking-tight text-zinc-900 lg:text-[42px]">
            {report.title}
          </h1>
        ...
        <div className="mt-10 rounded-xl border-l-4 border-zinc-900 bg-zinc-50 p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-[18px] leading-snug font-medium text-zinc-800">
              ...
              <BodyText className="mt-3" variant="secondary">
                ...
                enough, designing for 6-12 month disposable electrodes might
                beat 5-year hardened electrodes on total cost.
              </BodyText>
            </div>
          </div>
        </div>
        ...
        >
          <div className="p-8">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 border-t border-zinc-800 pt-6">
              <div>
                <p className="text-[12px] tracking-wide text-zinc-500 uppercase">
                  Investment
                </p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-zinc-200 bg-white p-6">
            <div className="flex items-center justify-between">
              <span className="rounded-full bg-zinc-100 px-2 py-0.5 text-[11px] font-semibold tracking-wide text-zinc-600 uppercase">
                Fallback
              </span>
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] font-semibold tracking-wide text-amber-600 uppercase">
              Paradigm Shift
            </span>
          </div>
