  ...
  result: {
    ...
    novelty_assessment: {
      ...
      key_prior_art: [
        ...
        {
          reference: 'US10322940B2 (BASF, 2019) - Bubble column reactor patent',
          relevance:
            'Broad claims on molten metal bubble column configurations',
          impact:
    ...
    moat_assessment: {
      ...
      vulnerabilities: [
        ...
        {
          vulnerability: 'No blocking IP—competitors can work around patents',
          severity: 'MEDIUM',
        },
        {
          vulnerability:
...
try {
  ...
  console.log('\nOne Page Summary Company:', report.one_page_summary?.company);
...
try {
  ...
  console.log(
    'Header company_name (defaulted):',
    malformedReport.header.company_name,
  );
